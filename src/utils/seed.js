...
const ROLE_DEFS = [
  ...
  },
  {
    ...
    perms: ['institute.view','student.view','student.view_all','student.update',
      'employee.view','academic.view','academic.create','academic.update',
      'attendance.view','attendance.create','attendance.update',
  ...
  },
  {
    ...
    perms: ['finance.view','finance.reports.view','fee.view','report.finance.view'],
  },
  {
    name: 'HR_MANAGER', displayName: 'HR Manager', isSystem: true,
    perms: ['employee.view','employee.create','employee.update','employee.delete',
      'hr.view','hr.leave.view','hr.leave.approve','attendance.view','report.hr.view'],
  },
  {
